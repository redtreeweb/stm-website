...
const OurApproach = () => (
  ...
  <div className="" style={{flex: 1}}>
    ...
    <div class="row">
      ...
      <div class="large-5 columns jamie-bio">
        <h5 class="jamie-name name">JAMIE HOLLERAN</h5>
      ...
      <div class="large-5 columns nathan-bio">
        <h5 class="nathan-name name">NATHAN WADDING</h5>
